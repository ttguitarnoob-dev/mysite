    ...
    <div className="App">
      <div className='welcome'>
       <img width={100} src={logo} />
        ...
        <p>This site hasn't launched yet, but if you are patient enough to wait and keep watching, it may be the home to some of the best stories you've ever experienced</p>
